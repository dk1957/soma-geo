-- Fix cross-brand data leakage in get_source_citation_analysis
-- The function was filtering by account_id instead of brand_id,
-- causing sources from other brands to appear in a brand's dashboard
-- ============================================================================
